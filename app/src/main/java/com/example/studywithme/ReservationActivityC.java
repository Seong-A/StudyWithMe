...
public class ReservationActivityC extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if ("cafe1".equals(cafeId)) {
            layoutResourceId = R.layout.activity_reservation_a3;
            totalSeats = 8;
        } else if ("cafe2".equals(cafeId)) {
            layoutResourceId = R.layout.activity_reservation_b3;
            totalSeats = 8;
        } else if ("cafe3".equals(cafeId)) {
            layoutResourceId = R.layout.activity_reservation_c3;
            totalSeats = 8;
        } else if ("cafe4".equals(cafeId)) {
            layoutResourceId = R.layout.activity_reservation_d3;
            totalSeats = 8;
        } else {
            return;
        }
